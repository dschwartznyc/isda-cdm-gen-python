...
class EconomicTerms(BaseDataClass):
  ...
  @rosetta_condition
  def condition_5_AssetPayoutDividendTermsValidation(self):
    """
    ...
    return if_cond_fn(((self.payout.assetPayout.dividendTerms) is not None), _then_fn0, _else_fn0)
  ...
  def condition_6_ExtendibleProvisionExerciseDetails(self):
    ...
    return if_cond_fn(((self.payout.assetPayout) is None), _then_fn0, _else_fn0)
