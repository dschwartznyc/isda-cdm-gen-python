...
class SettlementProvision(BaseDataClass):
  ...
  """
  shapingProvisions: Optional[ShapingProvision] = Field(None, description="Defines the parameters that are necessary to 'shape' a settlement, i.e. break it down into smaller amounts.")
  """
  Defines the parameters that are necessary to 'shape' a settlement, i.e. break it down into smaller amounts.
  """

from cdm.product.common.settlement.ShapingProvision import ShapingProvision

SettlementProvision.update_forward_refs()
