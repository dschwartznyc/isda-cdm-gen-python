...
class AgreementName(BaseDataClass):
  ...
  def condition_0_AgreementType(self):
    ...
    def _else_fn2():
      return if_cond_fn(any_elements(self.agreementType, "<>", LegalAgreementTypeEnum.CONFIRMATION), _then_fn3, _else_fn3)
    
    def _then_fn1():
      return ((self.masterAgreementType) is None)
    
    def _else_fn1():
      return if_cond_fn(any_elements(self.agreementType, "<>", LegalAgreementTypeEnum.MASTER_CONFIRMATION), _then_fn2, _else_fn2)
