...
class TradableProduct(BaseDataClass):
  ...
  def condition_3_PerformancePayout_ExtraordinaryDividendsParty(self):
    ...
    return if_cond_fn(((self.product.contractualProduct.economicTerms.payout.performancePayout.returnTerms.dividendReturnTerms.extraordinaryDividendsParty) is not None), _then_fn0, _else_fn0)
