...
class InflationRateSpecification(FloatingRateSpecification):
  ...
  """
  calculationMethod: Optional[InflationCalculationMethodEnum] = Field(None, description="Indicates how to use the inflation index to calculate the payment (e.g. Ratio, Return, Spread). Added for Inflation Asset Swap")
  """
  Indicates how to use the inflation index to calculate the payment (e.g. Ratio, Return, Spread). Added for Inflation Asset Swap
  """
  calculationStyle: Optional[InflationCalculationStyleEnum] = Field(None, description="Indicates the style of how the inflation index calculates the payment (e.g. YearOnYear, ZeroCoupon).")
  """
...
from cdm.observable.asset.calculatedrate.InflationCalculationMethodEnum import InflationCalculationMethodEnum
from cdm.observable.asset.calculatedrate.InflationCalculationStyleEnum import InflationCalculationStyleEnum
