...
class Collateral(BaseDataClass):
  ...
  """
  collateralProvisions: Optional[CollateralProvisions] = Field(None, description="specifies the collateral provisions of the product.")
  """
  ...
  def condition_0_CollateralExists(self):
    ...
    """
    return (((self.independentAmount) is not None) or ((self.collateralPortfolio) is not None))
  ...
  def condition_1_CollateralProvisions(self):
    ...
    """
    def _then_fn0():
      return ((self.collateralProvisions) is not None)
    
    def _else_fn0():
      return True
    
    return if_cond_fn(((self.collateralPortfolio) is not None), _then_fn0, _else_fn0)
...
from cdm.product.collateral.IndependentAmount import IndependentAmount
