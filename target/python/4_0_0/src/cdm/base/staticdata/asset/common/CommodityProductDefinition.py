...
class CommodityProductDefinition(BaseDataClass):
  ...
  """
  commodityInfoPublisher: Optional[CommodityInformationPublisherEnum] = Field(None, description="Specifies the publication where the commodity prices can be found.")
  """
...
from cdm.base.staticdata.asset.common.CommodityInformationPublisherEnum import CommodityInformationPublisherEnum
