...
ROSETTARUNTIMEDIR="../../cdm-distribution-python-4.0.0-dev.49/lib"
PYTHONCDMDIR="../../cdm-distribution-python-4.0.0-dev.49/lib"
#VERSION="3_3_2"
VERSION="4_0_0"
cd $MYPATH
...
$PYEXE -m pip install $MYPATH/$PYTHONCDMDIR/python_cdm-4.0.0-py3-none-any.whl 
